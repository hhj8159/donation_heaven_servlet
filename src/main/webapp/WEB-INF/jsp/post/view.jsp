                ...
                <main class="container">
                    ...
                    <div class="card border-start-0 border-end-0 rounded-0 border-2">
                        <div class="card-header">
                            ...
                            <div class="dropdown">
                                <div class="text-end"><span>${post.id}</span> <a class="nav-link dropdown-toggle d-inline" href="#" role="button" data-bs-toggle="dropdown">mekwon</a>
                                    <ul class="dropdown-menu">
                                        <li><a class="dropdown-item" onclick="return confirm('이 회원을 차단하시겠습니까?')">차단</a>
                                        </li>
                                    </ul>
                                </div>
                                <p class="text-end mb-0">작성일 ${post.regdate}</p>
                        ...
                        <div class="card-footer bg-white">
                            ...
                            <c:forEach items="${post.attaches}" var="a">
