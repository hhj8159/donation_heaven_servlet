         ...
         <main class="container">
            ...
            <div class="card border-start-0 border-end-0 rounded-0 border-2">
                <div class="card-header">
                    <div><p class="text-center" style="font-size: 20px;"><b>제목</b></p></div>
                    <div>
                        <p class="text-end mb-0">작성자 <a href="#" class="text-decoration-none text-reset">mekwon</a></p>
                ...
                <div class="text-center my-5">
                    <a href="modify" class="btn text-light" style="background-color: #005B48; width: 70px;" onclick="return confirm('추천하시겠습니까?')">추천</a>
                    <a href="list.html" class="btn text-light" style="background-color: #005B48; width: 70px;">목록</a>
