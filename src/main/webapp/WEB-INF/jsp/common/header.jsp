...
<header class="container-fluid">     
            <nav class="navbar bg-white navbar-expand-sm">
                <ul class="navbar-nav container justify-content-start" style="width:959px">
                    ...
                    <li class="mx-1 nav-item"><a class="nav-link text-success" href="${cp}post/list?category=4"><b class="font-color">봉사인증</b></a></li>
               	...
               	<c:if test="${not empty sessionScope.member}">
                       ...
                       <div class="sign" style="margin-top: 30px;" >
                 	   ...
                 	   <ul class="dropdown-menu">
                            ...
                            <li><a class="dropdown-item" href="${cp}donehistory">후원관리</a></li>
